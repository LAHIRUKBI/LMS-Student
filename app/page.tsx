...
import Navbar from "@/app/components/Navbar"; // Navbar Component එක මෙතනින් import කර ඇත
...
export default function StudentDashboard() {
  ...
  const handleLogout = async () => {
    await auth.signOut(); // Firebase session logout
    localStorage.removeItem("token");
    localStorage.removeItem("user");
    router.push("/login");
  };

  // Filter data based on Search and Tabs
